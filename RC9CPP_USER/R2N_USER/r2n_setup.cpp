...
demo test2, test3;
go1can go1(0, &hcan1, 0.0f, 0.0f, 0.0f); // 0.017f, 0.000024f, 0.00001f
...
void demo::process_data()
{
    ...
    data_chain.tx_frame_mat.data.msg_get[2] = go1.relative_angle;

    go1.speed_pid.PID_SetParameters(data_chain.rx_frame_mat.data.msg_get[0], data_chain.rx_frame_mat.data.msg_get[1], data_chain.rx_frame_mat.data.msg_get[2]);
