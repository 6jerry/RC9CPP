...
m6020s m6020_left_front(4, &hcan2), m6020_right_front(1, &hcan2), m6020_left_back(2, &hcan2), m6020_right_back(3, &hcan2); // 舵向电机
...
vesc vesc_left_front(2, &hcan1, false), vesc_right_front(4, &hcan1), vesc_left_back(3, &hcan1, true), vesc_right_back(1, &hcan1); // 航向电调
...
extern "C" void shootcar_setup()
{
    ...
    m6020_left_front.set_init_angle(224.192f);
    m6020_left_back.set_init_angle(344.97f);
    m6020_right_back.set_init_angle(148.16f);
    m6020_right_front.set_init_angle(179.36f);
...
void demo::process_data()
{
    ...
    // vesc_right_back.set_rpm(600.0f);
