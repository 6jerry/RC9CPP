...
m6020s m6020_left_front(4, &hcan1), m6020_right_front(1, &hcan1), m6020_left_back(2, &hcan1), m6020_right_back(3, &hcan1); // 舵向电机
...
vesc vesc_left_front(2, &hcan2), vesc_right_front(4, &hcan2), vesc_left_back(3, &hcan2), vesc_right_back(1, &hcan2); // 航向电调
