...
m3508p motor_1(1,&hcan1,true), motor_2(2,&hcan1,true,49.1376f), motor_3(3,&hcan1);
vesc motor_4(4,&hcan2);
...
extern "C"
{
    void LJH_test_setup()
    {
        ...
        xbox_test.add_trigger(GPIOA, GPIO_PIN_7, GPIOF, GPIO_PIN_6, GPIOC, GPIO_PIN_13, GPIOA, GPIO_PIN_7);
        motor_1.start_debug();
