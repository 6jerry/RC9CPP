...
private:
    ...
    planInfo plan_info;
    float dis_data[9] = {0.023f, 0.1968f, 0.1958f, 0.2190f, 0.2337f, 0.228f, 0.172f, 0.1800f, 0.2211f};
    float lidar_data[9] = {0.023f, 0.1998f, 0.1948f, 0.1937f, 0.1937f, 0.1877f, 0.2420f, 0.2420f, 0.2211f};
    // 标准俯仰                     篮下俯仰（待测量）
