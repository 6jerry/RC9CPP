...
extern "C"
{
    ...
    void yunball_test_setup(void)
    {
        ...
        can_core.init();
        autoshooter.add_imu(&encoder, &imu);
        autoshooter.add_trigger(GPIOB, GPIO_PIN_7, GPIOC, GPIO_PIN_14, GPIOC, GPIO_PIN_15);
        ...
        xbox_test.add_trigger(GPIO_PIN_13, GPIOC);
    ...
    void auto_shooter_setup(void)
    {
        ...
        autoshooter.add_imu(&encoder, &imu);
        autoshooter.add_trigger(GPIOF, GPIO_PIN_7, GPIOC, GPIO_PIN_14, GPIOC, GPIO_PIN_15);
        autoshooter.add_motor(&m8080, &pithcer);
        xbox_test.add_auto_shooter(&autoshooter);
        xbox_test.addport(&esp_port);
        xbox_test.add_motor(&lifter, &turnner);
