...
void AllController::auto_yunball_and_loadball()
{
    crsf_port->reset_trigger_flag();
}

void AllController::auto_shoot_2_center_point()
{
    crsf_port->reset_trigger_flag();
}

void AllController::auto_shoot_2_r2()
{
    crsf_port->reset_trigger_flag();
}

void AllController::reset_yunball_shooter()
{
    crsf_port->reset_trigger_flag();
}

void AllController::set_center_point()
{
    crsf_port->reset_trigger_flag();
}

void AllController::hand_set_lifter()
{
}
