...
public:
    m6020s(uint8_t can_id, CAN_HandleTypeDef *hcan_, bool if_double_control_ = true, float kp_r = 270.0f, float ki_r = 1.8f, float kd_r = 6.0f, float kp_p = 5.0f, float ki_p = 0.0f, float kd_p = 2.0f);
